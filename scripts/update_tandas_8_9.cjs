...
const sitios = [
    // Tanda 8
    {
        ...
        nombre_buscar: '%Teatro La Concha%',
    ...
    },
    {
        ...
        nombre_buscar: '%Teatro del Presagio%',
    ...
    },
    {
        ...
        nombre_buscar: '%Instituto Popular de Cultura%',
    ...
    },
    {
        ...
        horario: 'Según programación de eventos.',
    ...
    },
    {
        ...
        nombre_buscar: '%Castillo Sol y Luna%',
    ...
    },
    {
        ...
        nombre_buscar: '%Colectivo Teatral Infinito%',
    ...
    },
    {
        ...
        nombre_buscar: '%Cementerio Central%',
    ...
    // Tanda 9
    {
        ...
        nombre_buscar: '%Iglesia de San Antonio%',
    ...
    },
    {
        ...
        nombre_buscar: '%Iglesia de San Nicolás%',
    ...
    },
    {
        ...
        nombre_buscar: '%Casa de los Títeres%',
        ...
        datos_historicos: '1982: Leonor Amelia Pérez y Gerardo Potes fundan el Pequeño Teatro de Muñecos, inspirados por el maestro Juan Enrique Acuña, del Moderno Teatro de Muñecos de Costa Rica.\n27 de marzo de 1998: inauguración de la Casa de los Títeres en San Antonio.\n2001: obtiene la condición de Sala Concertada del Ministerio de Cultura.',
        datos_curiosos: [
        ...
        horario: 'Funciones en temporada permanente: sábados 4:00 p. m. y domingos 11:00 a. m.; jueves y viernes para colegios con reserva previa.',
    ...
    },
    {
        ...
        nombre_buscar: '%Pascual Guerrero%',
    ...
    },
    {
        ...
        nombre_buscar: '%Coliseo El Pueblo%',
    ...
    },
    {
        ...
        horario: 'Abierta en días de evento (temporada taurina de Feria, conciertos y espectáculos), según agenda.',
        tarifa: 'Boletería según el evento.',
    ...
    },
    {
        ...
        horario: 'Funciones habitualmente viernes y sábado (7:30 p. m.); cine y recitales entre semana.',
    ...
    },
    {
        ...
        nombre_buscar: '%Alianza Francesa%',
        ...
        horario: 'Lunes a viernes, aprox. 8:00 a. m.–12:30 p. m. y 2:00–6:00 p. m.; mediateca también los sábados en la mañana.',
    ...
    },
    {
        ...
        nombre_buscar: '%Biblioteca%Centenario%',
        ...
        horario: 'Lunes a viernes, 8:00 a. m.–12:00 m. y 2:00–5:00 p. m.',
        tarifa: 'Gratuito.',
...
async function updateTandas() {
    console.log('Iniciando actualizacin de Tanda 8 y 9...');
    for (const site of sitios) {
        // Find existing site
        const { data: existing, error: searchError } = await supabase
            .from('sites')
            .select('id, nombre')
            .ilike('nombre', site.nombre_buscar)
            .limit(1);
        ...
        if (existing && existing.length > 0) {
            ...
            console.log(`Insertando nuevo sitio: ${site.nombre}`);
            const { error: insertError } = await supabase
                .from('sites')
                .insert([{ id: require('crypto').randomUUID(), lat: 3.4516, lng: -76.5320, ...siteData }]);
            if (insertError) console.error('Error insertando', insertError);
        }
    }
    console.log('Actualizacin de Tanda 8 y 9 completada.');
}
