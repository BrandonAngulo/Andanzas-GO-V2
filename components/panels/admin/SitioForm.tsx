    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 max-w-4xl bg-card p-6 rounded-2xl border border-border">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2 md:col-span-2">
                    <label className="text-sm font-semibold">URL de la Imagen / Logo *</label>
                ...
                <div className="space-y-2 md:col-span-2">
                    ...
                    <Textarea name="datosHistoricos" value={formData.datosHistoricos || ''} onChange={handleChange} rows={2} placeholder="Historia relevante..." />
                </div>
