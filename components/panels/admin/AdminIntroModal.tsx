...
const steps = [
    {
        ...
        description: 'Aquí puedes administrar el contenido y la operación cotidiana de Andanzas GO.',
    ...
    },
    {
        ...
        caution: 'La zona de encuentro es opcional y puede ser sugerida por Andanzas según la ruta.'
    },
    {
        icon: Gamepad2,
    ...
    },
    {
        ...
        allows: 'Tomar decisiones con datos reales y mantener reglas operativas configurables desde el panel.',
    ...
    return (
        <Dialog open={isOpen} onOpenChange={(open) => { if (!open && !isSaving) onClose(); }}>
            <DialogContent className="flex max-h-[90vh] max-w-2xl flex-col overflow-hidden p-0">
                <DialogHeader className="shrink-0 border-b bg-muted/30 p-6 pr-12">
                ...
                <div className="flex shrink-0 flex-col-reverse gap-3 border-t bg-muted/10 p-4 sm:flex-row sm:items-center sm:justify-between">
