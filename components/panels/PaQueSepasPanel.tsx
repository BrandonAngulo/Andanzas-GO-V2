                ...
                <div className="p-4 md:p-6 max-w-3xl mx-auto">
                    ...
                    {selectedEntry.image_url && (
                        <div className="w-full h-48 md:h-64 rounded-2xl overflow-hidden mb-6 bg-muted">
                            <img src={selectedEntry.image_url} alt={getTranslated(selectedEntry, 'title', language)} className="w-full h-full object-cover" style={imagePositionStyle(selectedEntry.image_position)} />
                        </div>
                    )}
