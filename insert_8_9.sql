INSERT INTO public.sites (nombre, descripcion, importancia, datos_historicos, datos_curiosos, horario, tarifa, direccion, tipo) VALUES
(
    'Teatro La Concha',
    'En una casa declarada Patrimonio Arquitectónico-Urbano de Cali, en pleno barrio San Antonio, funciona el Teatro La Concha: un espacio escénico al servicio de la comunidad artística iberoamericana. Fundado en 2007, hace parte de la Fundación de Teatro y Artes "Yolanda García Reina" y cuenta con una sala de mediano formato, una sala de exposición y un salón alterno para ensayos y montajes de pequeño formato. La casa guarda, además, una capa de memoria caleña: alberga de manera permanente la exposición del artista plástico Carlos Zuluaga sobre Jovita Feijóo, uno de los personajes populares más entrañables de la ciudad.',
    ...
    '2007: fundación del Teatro La Concha, dentro de la Fundación de Teatro y Artes "Yolanda García Reina".
...
(
    ...
    '2005: se conforma el grupo, con dramaturgia y dirección de Diego Fernando Montoya.
...
(
    ...
    '3 de diciembre de 2015: inauguración de Espacio T en el centro histórico.
2023: apertura de La Carpa T, su escenario de patio para largo formato.',
    ARRAY['La fórmula que lo define: obras de 15 minutos, para 15 personas, en salas de 15 metros cuadrados.','Leandro Fernández, su fundador, es hermano de algunos de los creadores del TEC (Teatro Experimental de Cali).','Entre función y función suele sonar salsa viejita.']::text[],
    'Funciones de microteatro entre 8:00 y 11:00 p. m., por temporadas (habitualmente jueves a sábado).',
    'Boletería por función; consumos de comida y bebida por aparte.',
    'Carrera 6 #4-80, barrio San Antonio.',
    'Arte y Teatro'
),
(
    'Fundación AESCENA',
    'AESCENA (Arte Escénico Nacional) es una fundación artística profesional que, desde hace más de dos décadas, funciona a la vez como escuela y como sala independiente. En su "Casa Aescena" ofrece programación permanente de teatro para adultos, jóvenes y niños —comedia, drama, experimental—, y una línea de formación integral en interpretación, dramaturgia y expresión corporal a cargo de docentes reconocidos de la escena local. Su equipo es interdisciplinario: al arte suma la sociología, el derecho, la comunicación social y la pedagogía.',
    ...
    'Lleva más de dos décadas de trabajo continuo como escuela y sala independiente.
...
(
    ...
    'Sus raíces están en el "Colectivo Teatral Espejos", hacia 1998; la sala como tal funciona desde 2004.
...
Cuenta con el respaldo de Compromiso Valle, la Fundación Fanalca, Bolívar Davivienda, la Cámara de Comercio, ProPacífico y la Alcaldía, entre otros.',
    ARRAY['Su filosofía es la "vitamina C": Cristo, confianza, cultura, carnaval, cariño, convivencia, comunidad y celebración. De ahí el nombre.','Su lema es "Todos somos los otros".','Uno de sus proyectos insignia es el "Desfile de la Luz", cada 7 de agosto por las calles del oriente (ha reunido hasta 800 participantes). Nació tras el asesinato de seis jóvenes, como un acto para llevar luz y honrar la vida de los muchachos del sector.','En su terraza guarda muñecos gigantes del Gato de Tejada, de Jovita y de la vendedora de chontaduros, destinados a un futuro Museo del Cali Viejo.']::text[],
    'Funciones habitualmente los sábados hacia las 7:00 p. m.; talleres los sábados.',
    'La entrada se paga con alimentos (un huevo, arroz, panela, atún…).',
    'Carrera 29A #45-72, barrio El Poblado I (Distrito de Aguablanca).',
    'Arte y Teatro'
),
(
    'Instituto Popular de Cultura (IPC)',
    'El Instituto Popular de Cultura —el IPC— es una de las instituciones que más ha marcado la vida artística de Cali. Nació por iniciativa del Concejo Municipal el 18 de diciembre de 1947, en pleno contexto de la "República Liberal", con una misión pionera: dar formación artístico-cultural a los sectores populares de la ciudad, entendiendo el arte como herramienta para educar y transformar la realidad social. Con el tiempo consolidó cuatro escuelas —Artes Plásticas, Danza, Música y Teatro— por donde han pasado generaciones de artistas, docentes y gestores culturales caleños.',
    ...
    '18 de diciembre de 1947: creación mediante el Acuerdo No. 450 del Concejo Municipal.
...
2023: al cumplir 76 años, el Ministerio de Educación aprueba la creación de la Institución Universitaria de las Culturas y las Artes Populares IPC (IUIPC), la primera de su tipo en el país, en el rehabilitado Edificio Coltabaco.',
    ARRAY['En sus inicios enseñaba también historia patria, educación cívica, geografía, higiene y urbanidad a las clases obreras.','Su publicación y sus encuentros han documentado, entre otras memorias, la de la ladera ("Siloé resiste"), enlazando con el Museo Popular de Siloé.']::text[],
    'Atención administrativa y clases según calendario académico.',
    'Formación pública; programas con matrícula según la institución.',
    'Sede histórica en San Fernando (Calle 4 #27-140); nueva sede IUIPC en el Edificio Coltabaco (Calle 12 #1-12).',
    'Museos y Cultura'
),
(
    'Teatro de Títeres Castillo Sol y Luna',
    'A veinte minutos de la ciudad, en la vereda Los Limones del corregimiento La Castilla, al oeste de Cali, hay un castillo de verdad: dos torres de aire medieval, zona verde y cielo abierto, hechas para que los niños tengan su teatro de títeres. Es el Castillo Sol y Luna, la única sala en forma de castillo y en zona rural de la ciudad. Lo soñó y lo construyó el maestro Reynel Osorio Torres —titiritero, actor y docente con más de 45 años de oficio— cuando se jubiló del Instituto Popular de Cultura e invirtió sus ahorros en levantar, con su familia, este espacio para la primera infancia.',
    ...
    'Fundado en 2002 por el maestro Reynel Osorio, junto a su esposa Luz Myriam García Franco y su hija Melisa Osorio García.
Ha participado en festivales de títeres departamentales, nacionales e internacionales.',
    ARRAY['Tiene programas de inclusión ("Somos diversos con derechos") para niños en situación de discapacidad, riesgo social o enfermedad: con niños ciegos, por ejemplo, dejan tocar los muñecos antes de la función para reconocerlos por la voz.','En el campus viven patos, gallinas, conejos, palomos y hasta una oveja llamada Cornelia, que pide guayabas.','Los niños de la vereda siempre entran gratis.']::text[],
    'Funciones los domingos; programación entre semana para colegios y grupos.',
    'Boletería para público general; gratuito para los niños de la vereda.',
    'Vereda Los Limones, corregimiento La Castilla (occidente rural de Cali).',
    'Arte y Teatro'
),
(
    'Colectivo Teatral Infinito',
    'El Colectivo Teatral Infinito es uno de los proyectos más conmovedores de la escena caleña: la primera —y durante mucho tiempo única— escuela de formación teatral para personas con discapacidad del país. Fundado en 2005 por el maestro Harold Molina (egresado del IPC) y Paula Macía, el CTI integra a niños, jóvenes y adultos, y muy especialmente a actores y actrices con Síndrome de Down, en producciones de nivel profesional. Su apuesta es demostrar, sobre las tablas, que lejos de la idea de "discapacidad" hay un talento enorme por mostrar.',
    ...
    '2 de diciembre de 2005: constitución de la Fundación Artística y Cultural Colectivo Teatral Infinito.
...
(
    ...
    'Hacia 1852 se adjudicó el terreno actual y se instaló allí el cementerio (tercera ubicación del camposanto católico de Cali).
...
Ha sido investigado por especialistas en patrimonio funerario, como el arquitecto Ricardo Hincapié (Universidad del Valle).',
    ARRAY['Junto a los mausoleos de mármol conviven "santos populares": tumbas convertidas en lugar de devoción, adornadas con flores, cartas, fotos y ofrendas.','La tumba de Jovita Feijóo enlaza este lugar con el Teatro La Concha (que le dedica una exposición) y con los muñecos del Cali viejo de Casa Naranja.','La presencia de los yanaconas en su origen conecta el sitio con el Museo Popular de Siloé, que también narra esa raíz indígena de la ciudad.']::text[],
    'Abierto al público en horario diurno.',
    'Ingreso libre.',
    'Centro-norte de Cali.',
    'Sitios Históricos / Otros'
),
(
    'Iglesia de San Antonio',
    'Coronando la colina que lleva su nombre, al occidente del centro, la Capilla de San Antonio es una de las reliquias coloniales más queridas de Cali. Su fachada blanca de adobe contrasta con el verde de la loma, y desde su atrio se abre una de las mejores panorámicas de la ciudad. Construida entre 1746 y 1747 con la técnica del calicanto, reúne tres estilos: barroco en el altar interior, mudéjar en el frente —con su arco de medio punto— y colonial en el techo de teja. En su interior guarda un altar mayor barroco y valiosas tallas de madera del siglo XVII, de estilo quiteño, presididas por San Antonio de Padua.',
    ...
    '1742: el párroco José de Alegría y Cayzedo impulsa una viceparroquia en la colina para facilitar la misa a los fieles de San Fernando, La Chanca y El Peñón.
...
1944: al cumplir 200 años se restaura; ese mismo año la venta de la colina generó tal rechazo comunitario que el municipio debió comprarla y convertirla en parque público.',
    ARRAY['A San Antonio se le pide pareja con la frase popular "San Antonio, dame novio", además de ayudar a encontrar objetos perdidos y proteger a los hijos.','La colina detrás de la iglesia conecta con el parque del acueducto que baja hacia el Zoológico.']::text[],
    'La colina y el parque están abiertos todo el día; la capilla abre en horarios de misa y visita.',
    'Entrada gratuita.',
    'Cima de la Colina de San Antonio, barrio San Antonio.',
    'Sitios Históricos / Otros'
),
(
    'Iglesia de San Nicolás',
    'En el centro de Cali, frente al parque de San Nicolás (o Parque 20 de Julio), se levanta la iglesia que le dio nombre a uno de los barrios fundacionales de la ciudad. La antigua capilla de adobe, dedicada a San Nicolás de Bari, se comenzó hacia 1770 frente a la plaza; el barrio, que primero se llamó "El Vallano", fue adoptando poco a poco el nombre del templo. El edificio que hoy vemos, más amplio, se empezó a construir en 1880 y se terminó en 1926, tras demoler la vieja capilla averiada por el terremoto de 1925.',
    ...
    'Hacia 1770: se inicia la capilla de adobe dedicada a San Nicolás de Bari.
...
(
    ...
    '20 de julio de 1937: inauguración, con un Torneo Panamericano de Fútbol por los 400 años de Cali; el primer partido, Colombia 3 - México 1.
...
2009–2011: remodelación integral para el Mundial Sub-20.',
    ARRAY['Curiosamente, las hinchadas de América y Deportivo Cali ocupan la misma tribuna (la parte alta del sur), al revés de la costumbre mundial.','El 17 de noviembre de 1982, durante un Clásico Vallecaucano, una trágica estampida en los minutos finales dejó una veintena de muertos: uno de los episodios más dolorosos de su historia.']::text[],
    'Abierto en días de partido y eventos; el exterior y sus alrededores se pueden recorrer libremente.',
    'Boletería según el evento.',
    'Barrio San Fernando, entre la Calle 5ª y la Avenida Roosevelt.',
    'Deportes y Recreación'
),
(
    'Coliseo El Pueblo',
    'Con su silueta que parece una nave espacial posada en el sur de Cali, el Coliseo El Pueblo es uno de los íconos de la arquitectura moderna de la ciudad. Fue diseñado por los arquitectos Enrique Richardson y Libia Yusti —pioneros de la modernidad caleña, formados en Francia—, con el cálculo estructural del ingeniero Guillermo González Zuleta. Se inauguró en julio de 1971 para los VI Juegos Panamericanos y tiene capacidad para unos 12.000 espectadores.',
    ...
    '22 de julio de 1967: Cali es elegida sede de los Panamericanos en Winnipeg (Canadá), superando a Santiago de Chile.
...
2023: celebra su bicentenario; ese mismo año el Distrito obtuvo el título que lo reconoce como patrimonio público de los caleños.',
    ARRAY['Entre sus egresados está el poeta nadaísta Jotamario Arbeláez.','Se eligió el nombre de la santa por coincidir su fiesta (20 de julio) con la fecha del grito de independencia nacional.']::text[],
    'Institución educativa pública en funcionamiento.',
    'No aplica.',
    'Carrera 15 con Calle 7ª, barrio San Bosco.',
    'Institucional'
);